...
1. Load `config/local/codex-for-legal/litigation-legal/CLAUDE.md` → risk calibration + relevant stakeholders.
2. Follow the workflow and reference below.
3. Read `config/local/codex-for-legal/litigation-legal/matters/[slug]/matter.md` + `config/local/codex-for-legal/litigation-legal/matters/[slug]/history.md` + log row from `_log.yaml`.
...
- `config/local/codex-for-legal/litigation-legal/matters/_log.yaml` — structured row
- `config/local/codex-for-legal/litigation-legal/matters/[slug]/matter.md` — narrative intake
- `config/local/codex-for-legal/litigation-legal/matters/[slug]/history.md` — event log
- `config/local/codex-for-legal/litigation-legal/CLAUDE.md` — risk calibration (so "risk: high" means something specific, not generic)
...
- Re-triage. If the user wants to re-triage, that's an `$litigation-legal:matter-update` with field changes — this skill reads, doesn't write.
