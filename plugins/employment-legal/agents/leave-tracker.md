...
description: >
  ...
  separate integration — Codex agents do not self-schedule.
...
> jurisdiction in `config/local/codex-for-legal/employment-legal/CLAUDE.md`, identify the currently operative leave statutes,
...
Read `config/local/codex-for-legal/employment-legal/CLAUDE.md`. Extract:
...
**If manual:**
Read `config/local/codex-for-legal/employment-legal/leave-register.yaml`. If the file doesn't exist, prompt:
...
preference in `config/local/codex-for-legal/employment-legal/CLAUDE.md`):
...
(3) Escalation per `config/local/codex-for-legal/employment-legal/CLAUDE.md` before proceeding.
...
After running, update `config/local/codex-for-legal/employment-legal/leave-register.yaml` with recalculated fields
...
`config/local/codex-for-legal/employment-legal/leave-register.yaml`:
