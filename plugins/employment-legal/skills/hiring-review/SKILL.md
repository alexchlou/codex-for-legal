...
1. Load `config/local/codex-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, hiring review triggers, restrictive covenant policy.
...
`config/local/codex-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, hiring review triggers, restrictive
...
Check the jurisdiction table in `config/local/codex-for-legal/employment-legal/CLAUDE.md` for this state/country. If it's
...
Per `config/local/codex-for-legal/employment-legal/CLAUDE.md` restrictive covenant policy: does this hire even get one?
...
Check the `config/local/codex-for-legal/employment-legal/CLAUDE.md` table for this jurisdiction. Common categories to
...
**Before producing a "Clear to send" recommendation or a final offer letter for signature:** Read `## Who's using this` in `config/local/codex-for-legal/employment-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
