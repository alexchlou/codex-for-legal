...
description: >
  ...
  Loaded by $employment-legal:expansion-kickoff and $employment-legal:expansion-update; not invoked directly.
...
Read `config/local/codex-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `config/local/codex-for-legal/employment-legal/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** config/local/codex-for-legal/employment-legal/expansion-[slug].yaml
