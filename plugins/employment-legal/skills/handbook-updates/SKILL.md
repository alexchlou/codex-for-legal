...
`config/local/codex-for-legal/employment-legal/CLAUDE.md` → handbook location, state supplements list, update cadence.
...
For each state supplement in `config/local/codex-for-legal/employment-legal/CLAUDE.md`:
