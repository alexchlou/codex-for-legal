...
1. Load `config/local/codex-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, handbook location.
...
`config/local/codex-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, handbook location and format.
