...
Adds a new leave entry to `config/local/codex-for-legal/employment-legal/leave-register.yaml` with the minimum
...
1. Read `config/local/codex-for-legal/employment-legal/CLAUDE.md` → jurisdiction table and Systems section.
...
3. Using the jurisdiction table in `config/local/codex-for-legal/employment-legal/CLAUDE.md`, look up the applicable leave
...
5. Write a new entry to `config/local/codex-for-legal/employment-legal/leave-register.yaml` using the leave register
