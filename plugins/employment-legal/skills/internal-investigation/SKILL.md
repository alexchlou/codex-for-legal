...
description: >
  ...
  and audience summaries. Loaded by $employment-legal:investigation-open, $employment-legal:investigation-add,
  $employment-legal:investigation-query, $employment-legal:investigation-memo, and $employment-legal:investigation-summary; not
  invoked directly.
...
Prepend the work-product header from `config/local/codex-for-legal/employment-legal/CLAUDE.md` → `## Outputs` (it differs by user role — see `## Who's using this`). Every file, log, memo, and summary produced by this skill opens with that header.
...
Read `config/local/codex-for-legal/employment-legal/CLAUDE.md` → escalation table, any investigation protocols noted.
...
`config/local/codex-for-legal/employment-legal/investigation-[matter-slug]/log.yaml`:
...
`config/local/codex-for-legal/employment-legal/investigation-[matter-slug]/sources-checklist.yaml`:

Generated from the investigation type. See sources checklist templates below.

`config/local/codex-for-legal/employment-legal/investigation-[matter-slug]/documents-reviewed.yaml`:
...
`config/local/codex-for-legal/employment-legal/investigation-[slug]/sources-checklist.yaml`.
...
If multiple investigation folders exist in `config/local/codex-for-legal/employment-legal/`, ask which matter this
...
Write the draft to `config/local/codex-for-legal/employment-legal/investigation-[slug]/memo.md`.
