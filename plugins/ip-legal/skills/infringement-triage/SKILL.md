...
Read `config/local/codex-for-legal/ip-legal/CLAUDE.md`. Pull:
...
- **Integrations** from `## Available integrations` — CourtListener (connector optional; not enabled in v1),
...
`config/local/codex-for-legal/ip-legal/matters/<matter-slug>/outputs/infringe-<mode>-<subject-slug>-YYYY-MM-DD.md`.
Otherwise write to
`config/local/codex-for-legal/ip-legal/outputs/infringe-<mode>-<subject-slug>-YYYY-MM-DD.md`
