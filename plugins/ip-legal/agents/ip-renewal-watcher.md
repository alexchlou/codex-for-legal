...
description: >
  ...
  channel named in `config/local/codex-for-legal/ip-legal/CLAUDE.md`
...
1. Read `config/local/codex-for-legal/ip-legal/CLAUDE.md` to
   get the alert destination (Slack (connector optional; not enabled in v1) channel, email list, or inline) and
