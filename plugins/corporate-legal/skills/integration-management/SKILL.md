...
5. Read/write `config/local/codex-for-legal/corporate-legal/deals/[code]/integration-tracker.yaml`.
...
Lives at `config/local/codex-for-legal/corporate-legal/deals/[code]/integration-tracker.yaml`. Read `deal-context.md` for
...
Read `config/local/codex-for-legal/corporate-legal/deals/[code]/deal-context.md`. If not found: ask for deal code name,
target company, close date, deal lead, and outside counsel. Write to
deal-context.md if it doesn't exist.

Read `config/local/codex-for-legal/corporate-legal/deals/[code]/closing-checklist.yaml` if it exists. Any items marked as
...
>   automatically from `config/local/codex-for-legal/corporate-legal/deals/[code]/closing-checklist.yaml`
...
> Is your contract repository connected? (Google Drive (connector optional; not enabled in v1), Box, SharePoint,
