...
1. Load `config/local/codex-for-legal/legal-builder-hub/CLAUDE.md` → practice profile.
...
`config/local/codex-for-legal/legal-builder-hub/CLAUDE.md` → practice profile, installed skills (don't suggest what's already installed).
...
Per `config/local/codex-for-legal/legal-builder-hub/CLAUDE.md` → new skill notifications:
