...
1. Load `config/local/codex-for-legal/legal-clinic/CLAUDE.md` → practice areas, jurisdiction.
...
`config/local/codex-for-legal/legal-clinic/CLAUDE.md` → practice areas, jurisdiction, supervision style.
...
> specifically. See $legal-clinic:research-start for a roadmap.]`
...
**Factual:** [list]
**Legal:** [list — these feed $legal-clinic:research-start]
...
work through them systematically — and can run $legal-clinic:research-start on each]
