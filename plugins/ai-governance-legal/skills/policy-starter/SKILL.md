...
1. Read `config/local/codex-for-legal/ai-governance-legal/CLAUDE.md`. If the practice profile is unpopulated, stop and direct to `$ai-governance-legal:cold-start-interview`.
