...
| Skill | Purpose |
|---|---|
| **cold-start-interview** | Writes `config/local/codex-for-legal/ai-governance-legal/CLAUDE.md` from interview + seed docs |
...
Your configuration is stored at `config/local/codex-for-legal/ai-governance-legal/CLAUDE.md` and survives plugin updates.
...
- The `## Company profile` section is the first block of `config/local/codex-for-legal/ai-governance-legal/CLAUDE.md` by convention. If
