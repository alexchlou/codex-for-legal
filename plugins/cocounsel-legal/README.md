...
CoCounsel Legal brings Westlaw (connector optional; not enabled in v1) Deep Research into Claude for CoCounsel Legal subscribers. Run jurisdiction-specific legal research across U.S. federal and state law and receive fully cited reports with Westlaw (connector optional; not enabled in v1) and Practical Law source links. Deep Research reports cite case law, statutes, regulations, administrative materials, Practical Law, secondary sources, and current awareness content. Ask follow-up questions in the same conversation. The connector launches with Westlaw (connector optional; not enabled in v1) Deep Research and will expand to additional CoCounsel Legal capabilities over time.

- Use CoCounsel Legal to run Westlaw (connector optional; not enabled in v1) Deep Research with fully cited reports including linked citations to Westlaw (connector optional; not enabled in v1) and Practical Law sources.
