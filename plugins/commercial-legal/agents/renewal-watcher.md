...
description: >
  ...
  Runs weekly by default. Posts to the channel named in `config/local/codex-for-legal/commercial-legal/CLAUDE.md` → House style
...
1. Read `config/local/codex-for-legal/commercial-legal/CLAUDE.md` to get the alert destination (Slack (connector optional; not enabled in v1) channel or email list).
