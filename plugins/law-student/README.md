...
Your practice profile is stored at `config/local/codex-for-legal/law-student/CLAUDE.md` and survives plugin updates. Everything else is in your working directory:
...
Your study profile at `config/local/codex-for-legal/law-student/CLAUDE.md` isn't static — it improves as you use the plugin. Skills tell you when an output used a default you should tune. You can re-run setup, edit the file directly, or tell a skill to record a new position.
...
- Bar prep targets your weak subjects from config/local/codex-for-legal/law-student/CLAUDE.md. It will keep coming back to them.
