...
1. Load `config/local/codex-for-legal/law-student/CLAUDE.md` → class list, professors, learning style.
...
- `config/local/codex-for-legal/law-student/CLAUDE.md` → current classes, professors, learning style
...
- Professor (from config/local/codex-for-legal/law-student/CLAUDE.md class list — tone and focus vary by professor)
- Class / subject area
...
**Professor-specific flavor (from config/local/codex-for-legal/law-student/CLAUDE.md notes):**
...
- **Predict jurisdiction-specific niche questions.** If the professor has known hobby horses, capture them in config/local/codex-for-legal/law-student/CLAUDE.md class notes and the skill can weight accordingly; otherwise, it works from general patterns.
