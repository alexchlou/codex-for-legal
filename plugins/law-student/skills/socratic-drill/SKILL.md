...
1. Load `config/local/codex-for-legal/law-student/CLAUDE.md` → learning style, classes, weak areas.
...
`config/local/codex-for-legal/law-student/CLAUDE.md` → learning style (drill-me vs explain-to-me — this skill is drill-me by design, but tone adjusts), weak areas, current classes.

## The drill

### Step 1: Pick the topic

User names it, or pull from weak areas in `config/local/codex-for-legal/law-student/CLAUDE.md`. If they keep avoiding a subject, that's the one to drill.
...
1. The student has actually uploaded materials (notes, outlines, case briefs, flashcards) referenced in `config/local/codex-for-legal/law-student/CLAUDE.md` → Seed materials, and
