...
1. Load `config/local/codex-for-legal/law-student/CLAUDE.md` → class, professor, exam format, syllabus.
...
7. Write `config/local/codex-for-legal/law-student/exam-forecasts/[class]/forecast-[YYYY-MM-DD].md`. Framed as weighting heuristic, not prediction.
...
- `config/local/codex-for-legal/law-student/CLAUDE.md` → current classes, exam formats, syllabus if captured
...
Write to `config/local/codex-for-legal/law-student/exam-forecasts/[class]/forecast-[YYYY-MM-DD].md`. Versioned — if the student gets another past exam mid-semester, re-run and append.
