...
1. Load `config/local/codex-for-legal/law-student/CLAUDE.md` → class, writing skill level, past feedback patterns.
...
7. Append to `config/local/codex-for-legal/law-student/writing-feedback/[student]/tracker.md` for pattern detection.
...
- `config/local/codex-for-legal/law-student/CLAUDE.md` → class, assignment type (if known), writing skill level, graded-essay feedback history
...
Append session summary to `config/local/codex-for-legal/law-student/writing-feedback/[student]/tracker.md`:
