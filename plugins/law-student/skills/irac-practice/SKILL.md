...
1. Load `config/local/codex-for-legal/law-student/CLAUDE.md` → classes, exam formats, outline locations, learning style.
...
6. Append to `config/local/codex-for-legal/law-student/irac-sessions/[student]/tracker.md` for pattern detection. Surface patterns after 3+ sessions.
...
- `config/local/codex-for-legal/law-student/CLAUDE.md` → current classes, exam formats, outline locations, learning style
- `config/local/codex-for-legal/law-student/irac-sessions/[student]/tracker.md` if exists — pattern tracking across sessions
...
Any cases, statutes, or rules referenced in this feedback were generated by an AI model and have not been verified. Before you rely on them in a rewrite or a graded essay, look them up on Westlaw (connector optional; not enabled in v1), Fastcase, CourtListener (connector optional; not enabled in v1), or your school's research tool. AI-generated citations are sometimes fabricated or misquoted.
...
Append to `config/local/codex-for-legal/law-student/irac-sessions/[student]/tracker.md`:
